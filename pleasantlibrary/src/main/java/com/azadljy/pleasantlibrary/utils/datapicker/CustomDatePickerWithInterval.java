...
public class CustomDatePickerWithInterval {
    ...
    public CustomDatePickerWithInterval(Context context, ResultHandler resultHandler, String startDate, String endDate) {
    ...
    private void addListener() {
        ...
        day_pv_start.setOnSelectListener(new DatePickerView.onSelectListener() {
            ...
            public void onSelect(String text) {
                ...
                Log.e("AppTAG", "onSelect: " + interval);
                if (interval != -100) {
                    Calendar calendar = Calendar.getInstance();
                    calendar.setTime(selectedCalender.getTime());
                    calendar.add(Calendar.DAY_OF_MONTH, interval);
                    int month1 = calendar.get(Calendar.MONTH) + 1;   //获取月份，0表示1月份
                    int day1 = calendar.get(Calendar.DAY_OF_MONTH);    //获取当前天数
                    month_pv_end.setSelected(month1 < 10 ? "0" + month1 : month1 + "");
                    day_pv_end.setSelected(day1 < 10 ? "0" + day1 : day1 + "");
                    selectedCalender1.set(Calendar.MONTH, month1 - 1);
                    selectedCalender1.set(Calendar.DAY_OF_MONTH, day1);
                }
            }
        });
        ...
        day_pv_end.setOnSelectListener(new DatePickerView.onSelectListener() {
            ...
            public void onSelect(String text) {
                ...
                Log.e("AppTAG", "onSelect: " + text);
//                if (interval != -100) {
//                    Calendar calendar = Calendar.getInstance();
//                    calendar.setTime(selectedCalender1.getTime());
//                    calendar.add(Calendar.DAY_OF_MONTH, -interval);
//                    int month1 = calendar.get(Calendar.MONTH) + 1;   //获取月份，0表示1月份
//                    int day1 = calendar.get(Calendar.DAY_OF_MONTH);    //获取当前天数
//                    month_pv_start.setSelected(month1 < 10 ? "0" + month1 : month1 + "");
//                    day_pv_start.setSelected(day1 < 10 ? "0" + day1 : day1 + "");
//                }
            }
        });
